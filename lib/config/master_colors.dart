...
class MasterColors {
  ...
  static Color secondary5 = const Color(0xFFF5F5F5);
  static Color secondary10 = const Color(0xFFEFEFEF);
  static Color secondary20 = const Color(0xFFCCCCCC);
  static Color secondary30 = const Color(0xFFB3B3B3);
  static Color secondary50 = const Color(0xFF808080);
  static Color secondary70 = const Color(0xFF4D4D4D);
  ...
  static Color? textColor5 = const Color(0xFF1E7D01);
  static Color? appBarTitleColor = white;

  ///
  /// Button Color
  ///
  static Color? buttonColor = mainColor;
  ...
  /// Icon Color
  ///
  static Color iconColor = mainColor;
  static Color ionRejectColor = const Color(0xFFF23A43);
  ...
  //Status color
  static Color successColor = const Color(0xFF1E7D01);
  ...
  static Color red = const Color(0xFFC42430);
